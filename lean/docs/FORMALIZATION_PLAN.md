...
- Source version / local files inspected: arXiv v11, local
  `source-audited.pdf` and `source.txt`; PDF SHA-256
  `0b3c727a204f7801a9598dacd7ca7fdb385e21ee6877992ea0eb13c0538d8ebf`.
- Source/version mismatch notes: PDF metadata says 24 February 2025 while the
  rendered first page says 25 February 2025; later arXiv v12 is out of scope.
- Complete named-result ledger status: one named Competitive Equilibrium
  definition and Propositions 1-6 inventoried by page; independent byte-pinned
  source-atom review is still pending.
...
- Proof strategy consequences:
  - Source proof route to follow: define the equilibrium primitives before
    restating and proving any full proposition.
  - Cleaner Lean route or reusable library route: `MainTheorems.lean` closes
    the local Section 3.1 zero-profit wage algebra with Mathlib field/order
    arithmetic and derives conditional threshold and two-type offer lemmas.
  - Major issues already reported to the user: all six generated Specs are
    semantically incomplete scaffold drafts; their six proof endpoints contain
    `sorry` and are not theorem proofs.
...
- Definitions / formatted paper objects: `n(z)` and the single-/two-layer
  profit formulas in Section 3.1; matching/resource equation (1); Definition
  (Competitive Equilibrium), page 13.
- Named lemmas / propositions / theorems / corollaries: Propositions 1-6 at
  pages 16, 18-19, 22, 22, 24, and 27. No separately named lemmas, theorems, or
  corollaries were found in the 35-page v11 PDF.
- Named assumptions / model conditions used by those results: `h∈(0,1)`,
  knowledge support `[0,1]`, the knowledge distribution and compute supply,
  firm optimization/zero profits, human/compute market clearing, and the
  maintained pre-AI simplification `h<h₀` before the comparative statics.
...
|---|---|---|---|---|---|
| Proposition 1 / page 16, Section 3.3, Proposition 1 | `proposition1_preAI_equilibriumSpec` -> `proposition1_preAI_equilibrium` | pending | pending | pending | `by sorry` |
| Proposition 2 / pages 18-19, Section 4, Proposition 2 | `proposition2_autonomousAI_equilibriumSpec` -> `proposition2_autonomousAI_equilibrium` | pending | pending | pending | `by sorry` |
| Proposition 3 / page 22, Section 5.1, Proposition 3 | `proposition3_occupational_displacementSpec` -> `proposition3_occupational_displacement` | pending | pending | pending | `by sorry` |
| Proposition 4 / page 22, Section 5.1, Proposition 4 | `proposition4_productivity_and_spanSpec` -> `proposition4_productivity_and_span` | pending | pending | pending | `by sorry` |
| Proposition 5 / page 24, Section 5.2, Proposition 5 | `proposition5_winners_at_extremesSpec` -> `proposition5_winners_at_extremes` | pending | pending | pending | `by sorry` |
| Proposition 6 / page 27, Section 6.1, Proposition 6 | `proposition6_nonautonomousAI_equilibriumSpec` -> `proposition6_nonautonomousAI_equilibrium` | pending | pending | pending | `by sorry` |
